...
base.tar:
	...
	docker run --name amazonwsl library/amazonlinux:2.0.20200207.1 /bin/bash -c "yum update -y; yum install -y util-linux-ng; yum clean all; rm -rf /var/cache/yum; pwconv; grpconv; chmod 0744 /etc/shadow; chmod 0744 /etc/gshadow;"
...
clean:
	...
	-sudo rm -r rootfs
	-rm base.tar
	-docker rmi amazonlinux:2.0.20200207.1